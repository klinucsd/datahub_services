...
from routes.its_footprint_report_map_for_region_20251027 import create_region_map
...
def get_footprint_data(db: Session, geojson_str: str, region_name: str):
    ...
    try:
        ...
        data_query = f"""
           ...
           FROM its.footprint_report_20251027_point_3310 AS fp,
                bbox,
                region_geom
...
@router.post("/its_footprint_report_for_geojson_region_20251027", include_in_schema=True)
