...
def create_region_map(db: Session, geojson_str: str = None, region_name: str = None,
                     ...
                     output_png=None, dpi=100, figsize=(16, 6), point_color='blue',
    ...
    """
    Create a map for a region defined by GeoJSON with MapTiler Positron background, WMS layer, and treatment points
